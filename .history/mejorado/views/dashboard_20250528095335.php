...
if (!$genderStats) {
    die("Error en la consulta de género: " . $mysqli->error);
}
...
<body class="bg-light">
    ...
    <script>
        ...
        new Chart(ctxGender, {
            type: 'doughnut',
            data: {
                labels: genderData.map(item => item.sexo),
                datasets: [{
        ...
        new Chart(ctxDepartment, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: departmentData.map(item => item.cantidad),
                    ...
                    tooltip: {
                        callbacks: {
                            label: function(context) {
                                ...
                                const percentage = departmentData[context.dataIndex].porcentaje;
                                return `${value.toLocaleString()} casos (${percentage}%)`;
