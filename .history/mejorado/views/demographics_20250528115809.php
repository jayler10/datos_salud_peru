...
<div class="stats-card">
    <h3 class="card-title">📉 Anemia según Rangos de Edad</h3>
    <?php if ($anemiaPorEdad && $anemiaPorEdad->num_rows > 0): ?>
    <table class="stats-table">
        <thead>
            <tr>
                <th>Rango de Edad</th>
        ...
        <tbody>
            <?php while($row = $anemiaPorEdad->fetch_assoc()): ?>
            <tr>
                <td><?= htmlspecialchars($row['rango_edad']) ?></td>
