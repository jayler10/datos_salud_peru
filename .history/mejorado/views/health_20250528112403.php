...
$casosAnemia = obtenerCasosAnemiaPorSexo($pdo);

$totalCasos = array_sum($casosAnemia);
...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="comparativa-anemia" style="max-width: 400px; margin: 20px auto; font-family: Arial, sans-serif;">
    <h2>Comparativa Casos de Anemia por Sexo</h2>
    ...
    <?php else: ?>
        <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
            <span>Hombres:</span>
            <strong><?php echo number_format($casosAnemia['Hombre']); ?></strong>
        </div>
        <div style="background: #f88; height: 25px; width: 100%; border-radius: 5px; margin-bottom: 15px;">
            <div style="background: #c00; height: 25px; width: <?php echo round(($casosAnemia['Hombre'] / $totalCasos) * 100); ?>%; border-radius: 5px;"></div>
        </div>

        <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
            <span>Mujeres:</span>
            <strong><?php echo number_format($casosAnemia['Mujer']); ?></strong>
        </div>
        <div style="background: #88f; height: 25px; width: 100%; border-radius: 5px;">
            <div style="background: #0044cc; height: 25px; width: <?php echo round(($casosAnemia['Mujer'] / $totalCasos) * 100); ?>%; border-radius: 5px;"></div>
        </div>
    <?php endif; ?>
</div>
    </div>
