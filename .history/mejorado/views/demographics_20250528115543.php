...
$anemiaPorEdad = $controller->getAnemiaByAgeRanges();
...
<div class="stats-card mt-8">
    <h3 class="card-title">
        <i class="fas fa-procedures"></i> Anemia por Rango de Edad
    </h3>
    <div class="overflow-x-auto">
        <table class="stats-table">
            ...
            <tbody>
                <?php
                $currentRange = '';
                while ($row = $anemiaPorEdad->fetch_assoc()):
                    $isNewRange = $currentRange !== $row['rango_edad'];
                    $currentRange = $row['rango_edad'];
                ?>
                <tr class="<?= $isNewRange ? 'new-range' : '' ?>">
                    <td><?= $isNewRange ? htmlspecialchars($row['rango_edad']) : '' ?></td>
                    <td><?= htmlspecialchars($row['dx_anemia']) ?></td>
