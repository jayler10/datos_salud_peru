...
<body>
    ...
    <ul>
        <li><strong>Sexo:</strong> M o F (varchar(10), obligatorio)</li>
        <li><strong>Departamento:</strong> Texto (varchar(50), obligatorio)</li>
        <li><strong>Provincia:</strong> Texto (varchar(50), obligatorio)</li>
        <li><strong>Distrito:</strong> Texto (varchar(50), obligatorio)</li>
        <li><strong>Altura msnm:</strong> Número entero (int, opcional)</li>
        <li><strong>Hemoglobina:</strong> Número decimal, formato 5,2 (decimal(5,2), opcional)</li>
        <li><strong>Diagnóstico de anemia:</strong> Texto (varchar(50), opcional)</li>
        <li><strong>Establecimiento:</strong> Texto (varchar(150), opcional)</li>
        <li><strong>Fecha de nacimiento:</strong> Fecha (date, opcional)</li>
    </ul>
</div>
