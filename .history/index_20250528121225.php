...
<body>
    ...
    <ul>
        <li><strong>Sexo:</strong> M o F (una sola letra, mayúscula o minúscula)</li>
        <li><strong>Edad en meses:</strong> Número decimal (ej. 36.50)</li>
        <li><strong>Ubicación:</strong> Departamento, Provincia, Distrito (texto)</li>
        <li><strong>Altitud:</strong> Altura en metros sobre el nivel del mar (entero)</li>
        <li><strong>Hemoglobina:</strong> Valor decimal (ej. 12.37)</li>
        <li><strong>Diagnóstico:</strong> Texto del diagnóstico de anemia</li>
        <li><strong>Fecha de hemoglobina:</strong> Fecha (YYYY-MM-DD)</li>
        <li><strong>Programas:</strong> Texto con programas separados por comas (ej. Juntos, SIS, Suplementación, Consejería)</li>
        <li><strong>Establecimiento:</strong> Nombre del establecimiento de salud</li>
    </ul>
</div>
