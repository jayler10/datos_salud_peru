    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="info-box">
                ...
                <ul>
                    <li><strong>Sexo:</strong> M o F (columna 9)</li>
                    <li><strong>Edad en meses:</strong> Número decimal (columna 10)</li>
                    <li><strong>Ubicación:</strong> Departamento, Provincia, Distrito (columnas 11-13)</li>
                    <li><strong>Hemoglobina:</strong> Valor decimal (columna 33)</li>
                    <li><strong>Diagnóstico:</strong> Texto del diagnóstico de anemia (columna 34)</li>
                    <li><strong>Fecha:</strong> Fecha de hemoglobina (columna 20)</li>
